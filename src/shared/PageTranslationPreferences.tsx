  ...
  return <div className="ft-page-preferences">
    ...
    {s.pageTranslationEnabled && <>
      <div className="ft-mode-buttons" role="group" aria-label={t("全文翻译模式", "Page translation mode")}>
        <button type="button" disabled={modeLocked} aria-pressed={s.pageTranslationMode === "manual"} onClick={() => update({ pageTranslationMode: "manual" })}>{t("按键翻译", "Key translation")}</button>
