...
后续扩展方案（2026-09-09）：[功能实现路径与技术方案](NEXT_PHASE_IMPLEMENTATION_PLAN.md)。涵盖双向互译、轻量阅读功能、网页全文双语排版和百度/Microsoft/Google/DeepL 官方 API 接入；属于后续规划，不改变本文首期范围。
...
下列结构保留早期设计背景；当前已统一为 `src/` 源码目录，实际结构见 [工程维护说明](../DEVELOPMENT.md)。
